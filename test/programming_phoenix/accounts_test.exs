defmodule ProgrammingPhoenix.AccountsTest do
  use ProgrammingPhoenix.DataCase, async: true
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns not found error with no matching user for email" do
      {:error, :not_found} = Accounts.authenticate_by_username_and_pass("unknownuser", @pass)
    end
  end
end
